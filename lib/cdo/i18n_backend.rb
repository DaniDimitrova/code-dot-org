...
module Cdo
  # Singleton I18n backend instance used by the web application.
  class I18nBackend < ::I18n::Backend::KeyValue
    include ::I18n::Backend::CacheFile

    CACHE_FILE = pegasus_dir('cache', 'i18n/cached')
    CACHE_SIZE = 1.gigabyte

    def initialize
      store = SqliteKeyValue.new(CACHE_FILE, size: CACHE_SIZE)
      super(store, false)
